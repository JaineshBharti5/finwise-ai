...
function analyzeScore() {
  ...
  let desc =
    "Poor credit history. Loan approval is highly unlikely without secure collateral.";
  let recs = [];
  ...
  if (score >= 750) {
    ...
    desc =
      "Superb credit worthiness! You qualify for premier interest rates and fast approvals.";
    recs = [
      {
        icon: "fa-shield-halved",
        title: "Maintain your score",
        desc: "Keep credit utilization under 30% and monitor your monthly reports.",
      },
      {
        icon: "fa-percentage",
        title: "Negotiate interest rates",
        desc: "Use your excellent score to demand lower processing fees and interest rates.",
      },
      {
        icon: "fa-credit-card",
        title: "Premium credit cards",
        desc: "You are eligible for rewards-heavy metal cards with high limits.",
      },
    ];
  } else if (score >= 650) {
    category = "GOOD";
    ...
    desc =
      "Decent credit score. Standard loan rates apply, but you have room to improve.";
    recs = [
      {
        icon: "fa-clock",
        title: "Pay bills on time",
        desc: "Ensure all credit card bills and EMI payments are made before the due date.",
      },
      {
        icon: "fa-chart-pie",
        title: "Reduce utilization ratio",
        desc: "Try to pay off card balances early to lower your revolving credit ratio.",
      },
      {
        icon: "fa-ban",
        title: "Avoid new inquiries",
        desc: "Minimize hard inquiries by not applying for multiple cards or loans simultaneously.",
      },
    ];
  } else {
    category = "POOR";
    ...
    desc =
      "Suboptimal credit score. High risk category. You must rebuild your repayment records.";
    recs = [
      {
        icon: "fa-exclamation-triangle",
        title: "Critical repayments",
        desc: "Clear outstanding defaults immediately and setup automated auto-debits.",
      },
      {
        icon: "fa-wallet",
        title: "Secured credit cards",
        desc: "Get a credit card against a fixed deposit (FD) and make small timely payments.",
      },
      {
        icon: "fa-file-invoice",
        title: "Review credit report",
        desc: "Check for reporting errors or duplicate records and raise disputes on CIBIL.",
      },
    ];
  }
  ...
  document.getElementById("scoreCategory").textContent =
...
async function getCreditAI() {
  ...
  const sysPrompt =
    "You are FinWise AI, an expert CIBIL consultant. Suggest specific, credit-improvement actions tailored to Indian citizens. Format with bullet points.";
  const userMsg = `
